...
```bash
npm install @reclaim/identity-react
# or
yarn add @reclaim/identity-react
```
...
import getReclaimAuth from '@reclaim/identity-react';
...
- [Complete setup guide](/reclaim-auth-react/setup)
- [Authentication hooks](/reclaim-auth-react/hooks)
- [Protected routes](/reclaim-auth-react/protected-routes)
- [Managing user data](/reclaim-auth-react/user-data)
