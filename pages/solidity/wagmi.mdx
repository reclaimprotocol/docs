...
function App() {
  ...
  const APP_SECRET = "YOUR_APP_SECRET_HERE" //TODO : replace with your APP_SECRET
...
Here is an example of what the ABI should look like: [ABI.](https://github.com/reclaimprotocol/reclaim-copy-pastable/blob/main/evm/src/contracts-artifacts/abi.ts)
```
src/
 |- abi.js
 |- App.js
...
Note that we will be using Optimism Goerli testnet for provider and example contract.
