...
- Your smart contract needs to be registered in Reclaim. Run the following script to generate a DappId and Nullifier
...
- Pass the dappld and nullifierin through your smart contract constructor.
...
- After ensuring that the user is merkelized, you can call your action() (for example airDrop()) which is in you smart contract.
