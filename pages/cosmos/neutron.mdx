...
- [CosmWasm contract](https://gitlab.reclaimprotocol.org/reclaim-clients/reclaim-cosmwasm/-/tree/neutron).
- [React client](https://gitlab.reclaimprotocol.org/reclaim-clients/reclaim-cosmwasm/-/tree/neutron-frontend).
...
This [Neutron contract](https://gitlab.reclaimprotocol.org/reclaim-clients/reclaim-cosmwasm/-/tree/neutron-client) serves as a client to our Reclaim contract. It takes Reclaim's contract address, handles proofs, and verifies them.

```bash copy
git clone https://gitlab.reclaimprotocol.org/reclaim-clients/reclaim-cosmwasm/-/tree/neutron-client?ref_type=heads
cd reclaim-cosmwasm
wasmkit compile
```
...
By running `wasmkit run scripts/verify.ts`, you can upload the contract, instantiate it, and verify a Reclaim proof on it.
