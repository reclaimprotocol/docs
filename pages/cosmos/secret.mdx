...
We will be using [Keplr](https://www.keplr.app/) as a wallet to interact with the frontend interface. Make sure that you have it installed.

You can access the final version of this walkthrough on [Github](https://github.com/reclaimprotocol/reclaim-secret-example).
...
### In VerifyProof, render a view that prompts the user to submit proofs.
