...
Give the node/verify.js file a quick read, make sure that you have the correct RPCs and contract addresses, search for the ```Uncomment for mainnet``` comment.
