...
<Cards>
  <Card title='Check reclaim architecture' href='/architecture' className='border-sky-200 border-2 border-opacity-25'/>
  <Card title='Get started' href='/' className='border-sky-200 border-2 border-opacity-25'/>
</Cards>
