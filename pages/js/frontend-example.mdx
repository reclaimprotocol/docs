...
<Callout type="warning">
  ...
  Instead, do this:
  1. Store sensitive stuff on your backend
  2. Get the SDK config from your backend
  3. Use `fromJsonString()` on the frontend to create your request and status URLs. (Check backend example for more details)
  
  This keeps your app secure and your secrets... well, secret! 🔒
</Callout>
