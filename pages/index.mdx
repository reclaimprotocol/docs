...
<p className="text-blue-300 italic">
  Reclaim SDKs make it simple to bring user activity, reputation, and identity
  from external websites into your own platform.
</p>
<br></br>
...
<br></br>
<Cards>
    <SdkCard title='NodeJs' subtitle='Integrate on Backend' link='js/backend-example' iconName='node' tag='Recommended'/>
    <SdkCard title='React' subtitle='Integrate on Web' link='js/frontend-example' iconName='reactjs' tag='Quick Start'/>
