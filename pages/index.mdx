...
<p className=''>
    Reclaim Protocol has SDKs for frontend, backend and on-chain applications. You can leverage these SDKs to build applications that has access to users' activity, reputation, and identity from websites across the internet. 

    For example,
    - Import the number of rides the user has taken on Uber to build a competing ride sharing platform 
    - Import the users' purchaing preferences using Amazon to provide discounts to the right users 
    - Enable economics on a blockchain using users' activity offchain
...
<br/>
Reclaim Protocol unlocks a new design space for applications to be built. If you are building a new application, we would love to talk to you. Ask your questions on our [Telegram group](https://t.me/TODO), and the core developers and founders of Reclaim Protocol will respond to you directly!
