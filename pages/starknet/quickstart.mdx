...
If you do not need to customize or add additional logic to the on-chain contract, you may skip the following steps and use [our pre-deployed contract on the Sepolia Testnet](https://sepolia.starkscan.co/contract/0x0765f3f940f7c59288b522a44ac0eeba82f8bf71dd03e265d2c9ba3521466b4e).
