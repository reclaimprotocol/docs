...
const Reclaim = () => {
	...
	const [sessionState, setSessionState] = useState<'IDLE' | 'STARTED' | 'COMPLETED' | 'FAILED'>('IDLE')

	const reclaimSDK = new ReclaimSDK('16d2487e-57cc-4d65-bd42-33a057942baf')
	...
	return (
		<div className='flex flex-col items-center'>
			{(sessionState !== 'STARTED') ? <button onClick={generateSession} className="h-12 bg-blue-500 rounded-md font-bold text-white w-1/3">Generate verification link</button>
