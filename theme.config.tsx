      ...
      banner: {
        ...
        text: (
          <div className="flex flex-col gap-1 p-2">
            <p>✨Works out of the box guarantee. If you face any issue at all, hit us up <a href="https://t.me/TODO@madhavan" target='_blank' className="underline ">on Telegram</a> and we will write the integration for you.</p>
          </div>
        )
      },
    head: (
