...
The SDK includes built-in logging that can be configured for debugging:
...
- `extensionID` (string): Optional in extension context, required for web integration
...
```javascript
// Enable debug logging in extension popup
