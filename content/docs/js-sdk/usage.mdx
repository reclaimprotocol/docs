...
This is available for Android, iOS, React Native, Flutter & Capacitor. To learn more, go to [InApp Integration docs](/inapp-sdks/introduction).

You can follow start verification documentation for each platform to learn more about integrating with them. For example, [React Native](../../react-native/usage#start-verification).
...
### More options
  ...
  <Accordion title="Error Handling">
    ...
    If the user cancels the session midway or after an error, Reclaim will send a POST request to you on the cancel callback URL with details.
    ...
    **More options**
    ...
    Redirection happens after the cancel callback is invoked by Reclaim. See [What triggers a Cancel Callback](#what-triggers-cancel-callback) for more details.
  </Accordion>
