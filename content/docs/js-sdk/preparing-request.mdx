...
> [!WARNING]
> Both [setContext](/js-sdk/preparing-request#set-address--message-as-context) and [setJsonContext](/js-sdk/preparing-request#set-json-context) overwrite each other.
