...
With the above steps completed, try running your project on any iOS device. You can now continue with our [React Native Get Started Guide](/react-native/install#basic-usage).
