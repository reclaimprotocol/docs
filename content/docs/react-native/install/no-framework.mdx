...
<Tabs groupId="rnandroid-language"  items={['Groovy', 'Kotlin']} >
```groovy tabs="Groovy"
...
With the above steps completed, try building & running your project on any iOS device. You can now continue with our [React Native Get Started Guide](/react-native/installation#basic-usage).
