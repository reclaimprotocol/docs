...
Understanding these events helps with debugging and monitoring your integration. For a comprehensive list of event types, refer to the [Log Event Types](/manual/inapp-sdks/advanced/log-event-types) documentation. 
