...
With the above steps completed, try building & running your project on any iOS device. You can now continue with our [React Native Get Started Guide](/manual/react-native/usage#basic-usage).
