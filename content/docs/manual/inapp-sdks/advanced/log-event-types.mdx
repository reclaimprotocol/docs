...
Understanding these events helps with debugging and monitoring your integration. You can use these events to track the user's journey and log them to your backend. For instructions on how to set up the log listener, refer to the [Troubleshooting](../../react-native/troubleshooting#reading-logs) documentation.
