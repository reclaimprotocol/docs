...
description: Known log event types and their descriptions received from logs
---
...
Understanding these events helps with debugging and monitoring your integration. You can use these events to track the user's journey and log them to your backend. For instructions on how to set up the log listener, refer to the [Troubleshooting](/manual/react-native/troubleshooting#reading-logs) documentation.

> [!TIP]
> This page lists the **Client-Side** log events. For Server-Side Analytics events (useful for post-mortem), see the [Server-Side Analytics Events](/troubleshooting/analytics-event) guide.
