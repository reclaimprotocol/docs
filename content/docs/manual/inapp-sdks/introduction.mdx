...
The InApp SDKs are available on all major mobile platforms. For each platform, you can find the installation & usage instructions in the following pages:

* [Android](/manual/android/installation)
* [iOS](/manual/ios-swift/installation)
