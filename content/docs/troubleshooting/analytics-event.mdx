...
2.  **Client-Side Log Events:** Emitted locally by the InApp SDK. Useful for diagnosing issues with an InApp SDK session. [View Client-Side Logs Documentation](../manual/inapp-sdks/advanced/log-event-types).
