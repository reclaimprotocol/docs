...
2.  **Client-Side Log Events:** Emitted locally by the SDK. Useful for real-time debugging during development. [View Client-Side Logs Documentation](../inapp-sdks/advanced/log-event-types).
