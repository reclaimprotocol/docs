...
Read more about setting a cancellation callback [here](/manual/js-sdk/usage#what-triggers-cancel-callback).
...
[**View Client-Side Log Event Types →**](/manual/inapp-sdks/advanced/log-event-types)
