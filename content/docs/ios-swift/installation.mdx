---
<<<<<<<< HEAD:content/docs/ios-swift/installation.mdx
title: Installation
...
>>>>>>>> 44a0fc4 (Add introduction, backend verification docs to the `inapp/` documentation (#49)):content/docs/inapp-sdks/installation/ios.mdx
---
