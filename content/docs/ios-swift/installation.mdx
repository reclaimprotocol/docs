...
pod 'ReclaimInAppSdk', '~> 0.34.0'
```

```ruby tabs="From a specific tag"
pod 'ReclaimInAppSdk', :git => 'https://github.com/reclaimprotocol/reclaim-inapp-ios-sdk.git', :tag => '0.34.0'
```
...
```swift tabs="version"
.package(url: "https://github.com/reclaimprotocol/reclaim-inapp-ios-sdk.git", from: "0.34.0")
```
...
Now continue with our [Usage guide](/ios-swift/usage).
