...
featureOptions: {
  ...
  // Custom privacy policy URL displayed in the verification flow
  privacyPolicyUrl: 'https://your-domain.com/privacy-policy',

  // Custom terms of service URL displayed in the verification flow
  termsOfServiceUrl: 'https://your-domain.com/terms-of-service',

  // Custom URL for potential failure reasons page shown when verification fails
  potentialFailureReasonsUrl: 'https://your-domain.com/failure-reasons',
}
```
