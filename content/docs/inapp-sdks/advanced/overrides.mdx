...
type ResponseMatch {
  value       String
  # Matching type: 'regex' for regular expressions, 'contains' for substring match.
  type        String
  invert      Boolean @default(false)
  # If true, this match is optional and won't cause failure if absent.
...
type ResponseRedaction {
  ...
  jsonPath String?
  regex    String?
  # Hashing method: 'oprf', 'oprf_mpc', or 'oprf_raw'. See Response Redaction docs.
