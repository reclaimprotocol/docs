...
Read more about [attestors's authentication here](https://github.com/reclaimprotocol/attestor-core/blob/main/docs/run-server.md#enabling-authentication).
...
This can be used in the `setVerificationOptions` method of the InApp SDK, which allows you to set a callback for providing an auth request to attestor.
