...
You can access the code of this walkthrough on [Github](https://github.com/reclaimprotocol/reclaim-move-client).
...
[dependencies]
---
Reclaim = { git = "https://github.com/reclaimprotocol/move-sdk-onchain-integration", rev = "[network]" }
---
```

Replace `[network]` with `main` for Mainnet, `testnet` for Testnet, or `devnet` for Devnet.

```toml copy
[dependencies]
---
Reclaim = { git = "https://github.com/reclaimprotocol/move-sdk-onchain-integration", rev = "testnet" }
---
```
