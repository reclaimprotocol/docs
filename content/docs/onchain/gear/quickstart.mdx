...
- [Gear contract](https://github.com/reclaimprotocol/gear-sdk-onchain-integration).
- [Frontend example](https://github.com/reclaimprotocol/reclaim-gear-example).
...
```bash copy
git clone https://github.com/reclaimprotocol/gear-sdk-onchain-integration.git
cd gear-sdk-onchain-integration
cargo b --workspace
```
...
```bash
git clone https://github.com/reclaimprotocol/reclaim-gear-example.git
