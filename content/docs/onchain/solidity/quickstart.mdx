...
This tutorial assumes that you have a frontend that requests proofs from the user and processes the response, like [JS](/manual/js-sdk/installation), [React Native](/manual/react-native/install), or [Flutter](/manual/flutter/installation).
