...
This tutorial assumes that you have a frontend that requests proofs from the user and processes the response, like [JS](/js-sdk/installation), [React Native](/react-native/install), or [Flutter](/flutter/installation).
