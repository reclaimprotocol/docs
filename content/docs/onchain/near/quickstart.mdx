...
- [Near contract](https://github.com/reclaimprotocol/near-sdk-onchain-integration).
- [Frontend](https://github.com/reclaimprotocol/reclaim-near-example).
...
This [Near contract](https://github.com/reclaimprotocol/near-sdk-onchain-integration) serves as a client to our Reclaim protocol. It instantiates Reclaim's contract, handles proofs, and verifies them.

```bash copy
git clone https://github.com/reclaimprotocol/near-sdk-onchain-integration
cd near-sdk
cargo near build
```
...
```bash
git clone https://github.com/reclaimprotocol/reclaim-near-example.git
