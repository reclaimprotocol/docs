...
- [CosmWasm contract](https://github.com/reclaimprotocol/secret-sdk-onchain-integration).
- [React client](https://github.com/reclaimprotocol/reclaim-secret-example).
...
This [Secret contract](https://github.com/reclaimprotocol/secret-sdk-onchain-integration) serves as a client to our Reclaim contract. It takes Reclaim's contract address and code hash, handles proofs, and verifies them.

```bash copy
git clone https://github.com/reclaimprotocol/secret-sdk-onchain-integration.git
cd secret-sdk-onchain-integration
make build
```
