...
- [CosmWasm contract](https://github.com/reclaimprotocol/reclaim-cosmwasm-wasmkit-client).
- [React client](https://github.com/reclaimprotocol/reclaim-archway-example).
...
This [Archway contract](https://github.com/reclaimprotocol/reclaim-cosmwasm-wasmkit-client) serves as a client to our Reclaim contract. It takes Reclaim's contract address, handles proofs, and verifies them.

```bash copy
git clone https://github.com/reclaimprotocol/reclaim-cosmwasm-wasmkit-client.git
cd reclaim-cosmwasm-wasmkit-client
wasmkit compile
```
...
We will continue building on the [reclaim react client](https://github.com/reclaimprotocol/reclaim-archway-example.git), new lines are highlighted below.
