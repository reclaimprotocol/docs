...
- [React client](https://github.com/reclaimprotocol/reclaim-neutron-example).
...
This [Neutron contract](https://github.com/reclaimprotocol/reclaim-cosmwasm-wasmkit-client) serves as a client to our Reclaim contract. It takes Reclaim's contract address, handles proofs, and verifies them.
...
We will continue building on the [reclaim react client](https://github.com/reclaimprotocol/reclaim-neutron-example), new lines are highlighted below.
