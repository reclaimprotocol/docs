...
- [Smart Contract Repository](https://github.com/reclaimprotocol/ink-sdk-onchain-integration)
- [Frontend Repository](https://github.com/reclaimprotocol/reclaim-aleph-example)
...
```bash copy
git clone https://github.com/reclaimprotocol/ink-sdk-onchain-integration.git
...
```bash
git clone https://github.com/reclaimprotocol/reclaim-aleph-example.git
