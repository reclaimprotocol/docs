...
<div className="not-prose" style={{ background: '#1c1c1c', borderRadius: '12px', padding: '1.25rem 1.5rem', marginTop: '-1.5rem', marginBottom: '0.75rem', border: '1px solid #2e2e2e' }}>
  <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.6rem' }}>
    <img src="/assets/claude-logo.svg" alt="Claude" style={{ width: '28px', height: '28px', flexShrink: 0 }} />
    <span style={{ fontSize: '1rem', fontWeight: 600, color: '#e5e5e5' }}>Integrate Reclaim Protocol with Claude Code</span>
  </div>
  <p style={{ fontSize: '0.8rem', color: '#888', margin: '0 0 0.6rem 0', lineHeight: 1.5 }}>
  ...
  <div style={{ display: 'flex', alignItems: 'stretch', gap: '0.5rem' }}>
    <a data-card="" href="https://github.com/reclaimprotocol/reclaim-claude-skill" target="_blank" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', background: '#D97757', color: '#fff', padding: '0.4rem 0.9rem', borderRadius: '6px', fontSize: '0.8rem', fontWeight: 600, textDecoration: 'none', lineHeight: 1, whiteSpace: 'nowrap' }}>
      <img src="/assets/github-logo.svg" alt="" style={{ width: '14px', height: '14px', flexShrink: 0 }} /><span>Get the Claude Skill</span>
    </a>
    <a data-card="" href="https://dev.reclaimprotocol.org" target="_blank" style={{ display: 'inline-flex', alignItems: 'center', background: 'transparent', color: '#aaa', padding: '0.4rem 0.9rem', borderRadius: '6px', fontSize: '0.8rem', fontWeight: 500, textDecoration: 'none', border: '1px solid #333', lineHeight: 1, whiteSpace: 'nowrap' }}>
